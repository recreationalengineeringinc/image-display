      ...
      <div className='image-description'>
        <div className='mainClothing'>
          {props.hoverState ? <div className='greyClothing' >
            <img id='greyClothing' src='https://rei-product.s3-us-west-1.amazonaws.com/greyOutClothing.png' style={{height: 'auto', width: props.mousePosition.height * 2.5151655, top: props.mousePosition.y - 370, left: props.mousePosition.x - ((0.957 * props.mousePosition.width) + 600)}} />
          </div> : null}
          {/* <div className='greyClothing'>
            <img id='greyClothing' src='https://rei-product.s3-us-west-1.amazonaws.com/greyOutClothing.png' style={{height: 'auto', width: props.mousePosition.height * 2.5151655, top: props.mousePosition.y - 460, left: props.mousePosition.x - ((0.957 * props.mousePosition.width) + 740.8)}} />
          </div> */}
